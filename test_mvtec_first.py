...
#     transformed_features_low = F.interpolate(transformed_features_low.unsqueeze(1), size=(height, width), mode='bilinear',
#                                          align_corners=False)
#     transformed_features = transformed_features_low.squeeze(1) * 0.9 + transformed_low_features_2 * 0.1
#     return transformed_features


# def apply_wavelet_transform_2(tensor):
#     wavelet1 = 'sym2'
#     batch_size, height, width = tensor.shape
...
#     transformed_features_low = F.interpolate(transformed_features_low.unsqueeze(1), size=(height, width), mode='bilinear',
#                                          align_corners=False)
#     transformed_features = transformed_features_low.squeeze(1)
#     transformed_features = multi_scale(transformed_features) * 0.1 + transformed_features
#     return transformed_features
...
if __name__ == '__main__':
    ...
    # paths
    parser.add_argument("--data_path", type=str, default="./visa/visa", help="path to test dataset")
    parser.add_argument("--save_path", type=str, default='./results/', help='path to save results')
    parser.add_argument("--checkpoint_path", type=str, default='./mvtecResults_liu/epoch_16.pth', help='path to checkpoint')
    # model
    parser.add_argument("--dataset", type=str, default='visa')
    parser.add_argument("--features_list", type=int, nargs="+", default=[6, 12, 18, 24], help="features used")
    parser.add_argument("--image_size", type=int, default=490, help="image size")  # pixel 490  image 518
