...
def train(args):
    ...
    for epoch in tqdm(range(args.epoch)):
        ...
        for items in tqdm(train_dataloader):
            ...
            image_loss_total = image_loss + image_loss_emo + image_loss_fusion + image_loss_class + random_loss * 0.5
            pixel_loss = loss * 0.001 + loss_emo
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", type=str, default='./mvtecResults', help='path to save results')
